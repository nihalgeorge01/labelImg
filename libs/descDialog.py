...
from libs.utils import newIcon, descValidator
...
class DescDialog(QDialog):
    ...
    def __init__(self, text="Enter object description", parent=None, listItem=None):
        super(DescDialog, self).__init__(parent)

        self.edit = QLineEdit()
        self.edit.setText(text)
        self.edit.setValidator(descValidator())
